    ...
    public class xFolderBrowserDialog
    {
        ...
        public string InitialDirectory
        {
            ...
            set
            {
                openFileDialog.InitialDirectory =
                    value == null || value.Length == 0 ? Environment.CurrentDirectory : value;
            }
        }
        ...
        public bool ShowDialog(IntPtr hWndOwner)
        {
            ...
            if (Environment.OSVersion.Version.Major >= 6)
            {
                ...
                uint options = (uint)r.CallAs(typeof(FileDialog), openFileDialog, "GetOptions");
        ...
        public class Reflector
        {
            ...
            public Reflector(string an, string ns)
            {
                ...
                m_asmb = null;
                foreach (
                    AssemblyName aN in Assembly.GetExecutingAssembly().GetReferencedAssemblies()
                )
                {
